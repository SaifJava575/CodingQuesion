...
public class Gr_17_MinmumCostPath {
	...
	public static void main(String[] args) {
		...
		int graph[][] = { { 9, 9, 4, 9 }, { 6, 7, 6, 4 }, { 8, 3, 3, 7 }, { 7, 4, 9, 10 } };
		int response = minimumCostPath(graph);
		System.out.println("The min cost path is " + response);
