...
public class Hd_58_SumOfSubString {

	private static String addString(String s, String t) {
	...
	private static boolean check(String s, int start, int len1, int len2, int n) {
